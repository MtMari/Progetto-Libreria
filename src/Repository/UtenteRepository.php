...
class UtenteRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
     ...
     */
    public function upgradePassword(PasswordAuthenticatedUserInterface $utente, string $newHashedPassword): void
    {
        if (!$utente instanceof Utente) {
            throw new UnsupportedUserException(sprintf('Instances of "%s" are not supported.', $utente::class));
        }
